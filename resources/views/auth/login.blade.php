...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="{{ route('auth.login') }}" method="post">
            <h1 class="h3 mb-3 fw-normal" style="font-family: Arial, Helvetica, sans-serif; font-size: 35px; font-weight: bold;">Administrateur</h1>

            @csrf

            <div class="form-floating">
                <input type="email" class="form-control" id="email" placeholder="name@example.com" value="{{ old('email') }}" name="email">
